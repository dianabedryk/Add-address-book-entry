...
class add_address_book(unittest.TestCase):
    ...
    def test_add_address_book(self):
        ...
        self.fill_add_address_book_entry(wd, Group(firstname="fh", middlename="olk", lastname="ery", nickname="plk", title="ujb", company="vbn", address="ikolm", home="olkmn", mobil="tyhju",
                                         work="zxcvb", fax="mnbvg", email="yujn", homepage="ikmnh", bday="12", bmonth="March", byear="1980", aday="10", amonth="February",
                                         ayear="2016", address2="hjgikkmbf", phone2="ukiolm", notes="yujnmki"))
    ...
    def test_add_empty_address_book(self):
        ...
        self.login(wd, username="admin", password="secret")
        self.open_add_new(wd)
        self.fill_add_address_book_entry(wd, Group(firstname="", middlename="", lastname="", nickname="",
    ...
    def fill_add_address_book_entry(self, wd, group):
